...
[![Latest Version](https://img.shields.io/github/release/nopaad/laravel-analytics.svg?style=flat-square)](https://github.com/nopaad/laravel-analytics/releases)
[![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE.md)
[![Build Status](https://img.shields.io/travis/nopaad/laravel-analytics/master.svg?style=flat-square)](https://travis-ci.org/nopaad/laravel-analytics)
[![Quality Score](https://img.shields.io/scrutinizer/g/nopaad/laravel-analytics.svg?style=flat-square)](https://scrutinizer-ci.com/g/nopaad/laravel-analytics)
...
[![Total Downloads](https://img.shields.io/packagist/dt/nopaad/laravel-analytics.svg?style=flat-square)](https://packagist.org/packages/nopaad/laravel-analytics)
...
Nopaad is a webdesign agency in Antwerp, Belgium. You'll find an overview of all our open source projects [on our website](https://nopaad.be/opensource).

## Postcardware

You're free to use this package (it's [MIT-licensed](LICENSE.md)), but if it makes it to your production environment you are required to send us a postcard from your hometown, mentioning which of our package(s) you are using.

Our address is: Nopaad, Samberstraat 69D, 2060 Antwerp, Belgium.
...
``` bash
composer require nopaad/laravel-analytics
```
...
![1](https://nopaad.github.io/laravel-analytics/v2/1.jpg)
...
![2](https://nopaad.github.io/laravel-analytics/v2/2.jpg)
...
![3](https://nopaad.github.io/laravel-analytics/v2/3.jpg)
...
![4](https://nopaad.github.io/laravel-analytics/v2/4.jpg)
...
![5](https://nopaad.github.io/laravel-analytics/v2/5.jpg)
...
![6](https://nopaad.github.io/laravel-analytics/v2/6.jpg)
...
![7](https://nopaad.github.io/laravel-analytics/v2/7.jpg)

You'll need the `View ID` displayed there.

![8](https://nopaad.github.io/laravel-analytics/v2/8.jpg)
...
If you discover any security related issues, please email freek@nopaad.be instead of using the issue tracker.
